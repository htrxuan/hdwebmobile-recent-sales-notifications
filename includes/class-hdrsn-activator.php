...
class HDRSN_Activator
{

    public static function activate()
    {
        if (!self::is_woocommerce_active()) {
            deactivate_plugins(plugin_basename(HDRSN_PLUGIN_FILE));
            set_transient('hdrsn_wc_missing_notice', true, 30);
            return;
        }
        ...
        // 'hdrsn_db_version' option -- see hdwebmobile-wholesale-pricing or
